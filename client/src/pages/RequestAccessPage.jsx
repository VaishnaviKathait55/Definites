...
//     if (name === 'query') {
//       const words = countWords(value);
//       if (words > 200) return; // block input beyond 200 words
//       setWordCount(words);
//     }
...
//       eyebrow="Contact Us"
//       title="Get in touch with us"
//       description="Fill in the form below and our team will get back to you. Each request is reviewed by an administrator before any account is created."
//       footer={
//         <p>
//           Already have credentials? <Link to="/login">Go to portal login</Link>.
//         </p>
...
//             required
//           />
//           <span className={`word-count ${wordCount >= 200 ? 'word-count-limit' : ''}`}>
//             {wordCount} / 200 words
//           </span>
//         </label>
...
//       title="Submit a controlled access request"
//       description="Prospective users do not self-register. Each request is reviewed by an administrator before any account is created."
//       footer={
//         <p>
//           Already have credentials? <Link to="/login">Go to portal login</Link>.
//         </p>
...
//         <button type="submit" className="btn-primary auth-submit-btn" disabled={status.loading}>
//           {status.loading ? 'Submitting request...' : 'Request access'}
//         </button>
//       </form>
//     </AuthPageLayout>
//   );
